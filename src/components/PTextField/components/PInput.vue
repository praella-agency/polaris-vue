...
@Component({
  components: {PFieldResizer, PSpinner, PIcon, quillEditor},
})
...
<style>
  ...
  .ql-toolbar.ql-snow > .ql-formats:not(:first-child):before {content: " ";height: calc(100% + 4px);width: 1px;background: #c4c4c4;position: absolute;display: block;top: -2px;left: -10px;}
